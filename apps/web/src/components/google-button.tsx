...
import { api, API_URL, type AuthProviders } from '@/lib/api';

/** Logotipo oficial de Google en SVG (permitido en botones de acceso). */
function GoogleLogo() {
  return (
...
/**
 * Solo se muestra si el servidor tiene configuradas credenciales de Google.
 * La navegación es completa (no fetch) porque el flujo OAuth es de redirección.
 */
